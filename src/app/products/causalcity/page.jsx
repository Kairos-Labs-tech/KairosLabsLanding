...
const data = {
  ...
  observation: `Cities are dynamic systems. Everything in one loops back on everything else: traffic shapes behavior, behavior reshapes traffic, weather sits underneath both. Pull one thread and the rest moves. A model that tries to predict the future, explain why it happened, and recommend a route all at once will be bad at all three.`,
