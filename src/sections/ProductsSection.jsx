...
const products = [
  ...
  },
  {
    ...
    pitch: `CiteWeave does not guess. It crawls the actual citation graph using PageRank-style ranking to determine foundational impact, and clusters exact sentences pulled from papers. Grounded in the real structural hierarchy of science, not a keyword match.`,
    specs: [
